  ...
  return <SalonShell search={search} onSearch={setSearch}><main>
    ...
    <section className="mx-auto max-w-[1240px] px-5 pb-6 pt-12 lg:px-8">
     ...
     <section className="mx-auto max-w-[1240px] px-5 pt-12 lg:px-8">
       <div className="relative overflow-hidden rounded-[28px] bg-[#168a98] px-7 py-10 text-[#382a25] sm:px-12 lg:flex lg:items-center lg:justify-between">
         <div className="absolute -right-8 -top-20 h-72 w-72 rounded-full border-[50px] border-[#9bc8c3]/60" /><div className="relative max-w-xl"><p className="text-xs font-bold uppercase tracking-[.2em] text-[#f5cf45]">Why goodroom?</p><h2 className="mt-3 font-serif text-4xl font-bold leading-[.95] tracking-[-.05em] sm:text-5xl">A better way to say<br /><em className="font-normal">“I deserve this.”</em></h2><p className="mt-5 max-w-md text-sm leading-relaxed text-[#382a25]/80">We partner with the salons you already love—and the ones you’re about to. Every offer is real, local, and easy to use.</p></div>
         <div className="relative mt-8 grid grid-cols-2 gap-x-10 gap-y-6 text-sm lg:mt-0"><div><p className="font-serif text-3xl font-bold text-[#f5cf45]">100%</p><span className="text-[#382a25]/75">local salons</span></div><div><p className="font-serif text-3xl font-bold text-[#f5cf45]">1 tap</p><span className="text-[#382a25]/75">to your voucher</span></div><div><p className="font-serif text-3xl font-bold text-[#f5cf45]">zero</p><span className="text-[#382a25]/75">mystery pricing</span></div><div><p className="font-serif text-3xl font-bold text-[#f5cf45]">good</p><span className="text-[#382a25]/75">energy only</span></div></div>
      </div>
    </section>
