...
export const seededDeals: Deal[] = [
  {
    ...
    endsAt: '2026-12-31T20:00:00', description: 'A considered refresh for hair that is ready for a little more light. Your stylist shapes, glosses, and finishes with a tailored blowout.',
  ...
  },
  {
    ...
    endsAt: '2026-11-28T18:00:00', description: 'A quiet, detail-first manicure with structured gel for a glossy finish that holds its shape.',
  ...
  },
  {
    ...
    endsAt: '2026-12-08T12:00:00', description: 'A 60-minute reset for skin that has been doing too much. Expect a considered cleanse, enzyme polish, and cool stone massage.',
  ...
  },
  {
    ...
    endsAt: '2026-11-25T16:00:00', description: 'A precise root refresh with a soft, glassy finish for the week ahead.',
